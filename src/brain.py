...
SYSTEM_INSTRUCTION = (
    ...
    "Du kan uttrykke hele repertoaret via action: build (bygg enhet, f.eks. "
    "fighter/scout, tank, walker), produce (lag våpen i Armory), follow, "
    "follow_close, go, attack, hunt, defend (=hold/stop), scavenge, recycle, "
    "pickup, repair, reload, nav (nav-beacon).\n"
    "Forstå forskjellen så du velger riktig kommando:\n"
    "- follow (Follow Me): enhetene følger deg OG rykker fram for å angripe "
    "fiender de ser, selv om du trekker deg tilbake. Bruk ved 'følg meg'.\n"
    "- follow_close: tett formasjon BAK deg, trekker seg tilbake sammen med "
    "deg. Bruk ved 'hold dere bak meg', 'ikke stikk av', 'følg tett'.\n"
    "- hunt: enhetene drar ut på EGEN HÅND og oppsøker fiender over hele "
    "kartet. Bruk ved 'gå og finn fiender', 'jakt dem', 'slipp dem løs'.\n"
    "- defend (=hold/stop): hold posisjon og vokt. Bruk ved 'hold stillingen', "
    "'stopp', 'forsvar her', 'bli stående'.\n"
    "- attack: angrip den nærmeste fienden nå.\n"
